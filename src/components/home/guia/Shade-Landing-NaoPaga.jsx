...
export function HeroGeometric({
 ...
 <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape 
          ...
          className="right-[35%] md:right-[10%] top-[50%] md:top-[15%]" 
        />
      </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <br />
              <span className={cn("bg-clip-text text-6xl sm:text-8xl md:text-9xl text-transparent font-zalando bg-gradient-to-r from-primaria via-white/90 to-secundaria")}>
                {title2}
              </span>
            </h1>
          </motion.div>
